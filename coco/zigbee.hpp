...
COCO_ENUM(NwkCommandRouteRequestOptions)
...
COCO_ENUM(NwkCommandRouteReplyOptions)
...
COCO_ENUM(NwkCommandRejoinRequestOptions)
...
COCO_ENUM(NwkCommandLinkStatusOptions)
...
COCO_ENUM(ZdpNodeDescriptorInfo)
...
COCO_ENUM(ZdpNodeDescriptorServerFlags)
